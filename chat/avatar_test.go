...
func TestAuthAvatar(t *testing.T) {
	...
	if err != ErrNoAvatarURL {
		t.Error("値が存在しない場合、AuthAvatar.GetAvatarURLは" + "ErrNoAvatarを返すべきです")
	}
...
// きちんとavatarURLが生成されるかどうか
func TestFileSystemAvatar(t *testing.T) {
	// テスト用のアバターのファイルを生成します
	filename := filepath.Join("chat/avatars", "abc.jpg")
